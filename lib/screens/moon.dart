                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      ...
                      await gogg();
                      http.Response ress = await http.get(Uri.parse(
                          "https://api.vedicastroapi.com/json/horoscope/findmoonsign?dob=$datei&tob=$timei&lat=$lat&lon=$lon&tz=$tmz&api_key=$keyy"));
                      var dsh = jsonDecode(ress.body)["response"]
                              ['bot_response']
                          .toString()
                          .replaceAll("Your moon sign is ", "")
                          .tr();
                      showDialog(
                        context: context,
                        builder: (context) {
