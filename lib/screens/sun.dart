                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      ...
                      await gogg();
                      http.Response ress = await http.get(Uri.parse(
                          "https://api.vedicastroapi.com/json/horoscope/findsunsign?dob=$datei&tob=$timei&lat=$lat&lon=$lon&tz=$tmz&api_key=$keyy"));
                      String dsh = jsonDecode(ress.body)["response"]
                              ['bot_response']
                          .toString()
                          .replaceAll("Your sun sign is ", "")
                          .tr();
                      showDialog(
                        context: context,
                        builder: (context) {
