...
class pitr extends StatefulWidget {
  @override
  _pitrState createState() => _pitrState();
}

class _pitrState extends State<pitr> {
  @override
  void initState() {
    super.initState();
    checknet();
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () async {
                      ...
                      await gogg();
                      http.Response ress = await http.get(Uri.parse(
                          "https://api.vedicastroapi.com/json/dosha/pitradosh?dob=$datei&tob=$timei&lat=$lat&lon=$lon&tz=$tmz&api_key=$keyy"));
                      var dshtf =
